...
- `history_db/`: SQLite-backed history and settings persistence with incremental schema migrations (`_migrations.py`), including explicit read/write transaction helpers for run lifecycle updates.
