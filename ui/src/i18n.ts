...
export const dict = {
    en: {
      ...
      "logs.generate_pdf": "Generate PDF",
      "logs.generating_pdf": "Generating...",
      "logs.pdf_failed": "Failed to generate PDF.",
      "logs.raw": "Raw",
      "logs.delete": "Delete",
      ...
      "logs.delete_all_confirm":
        "Delete all {count} log file(s)? This cannot be undone.",
      "logs.delete_failed": "Failed to delete log.",
      "logs.delete_all_partial":
        "Deleted {deleted} of {total} logs. {failed} failed.",
      "logs.loading_preview": "Loading run preview...",
      "logs.preview_unavailable": "Preview is unavailable for this run.",
      "logs.preview_heatmap_title": "Preview heatmap (p95 intensity)",
      "logs.preview_stats_title": "Sensor statistics",
      "logs.load_insights": "Load insights",
      "logs.reload_insights": "Reload insights",
      "logs.loading_insights": "Loading insights...",
      "logs.summary_created": "Created",
      "logs.summary_updated": "Updated",
      "logs.summary_size": "File size",
      "logs.summary_sensor_count": "Sensors",
      "logs.not_available": "n/a",
      "logs.table.location": "Location",
      "logs.table.samples": "Samples",
      "logs.table.dropped_delta": "Dropped Δ",
      "logs.table.overflow_delta": "Overflow Δ",
    ...
    nl: {
      ...
      "logs.generate_pdf": "PDF genereren",
      "logs.generating_pdf": "Genereren...",
      "logs.pdf_failed": "Genereren van PDF is mislukt.",
      "logs.raw": "RAW-log",
      "logs.delete": "Verwijderen",
      "logs.delete_all": "Alle logs verwijderen",
      "logs.no_available": "Geen logs beschikbaar",
      "logs.delete_confirm": 'Log "{name}" verwijderen? Dit kan niet ongedaan worden gemaakt.',
      "logs.delete_all_confirm":
        "Alle {count} logbestand(en) verwijderen? Dit kan niet ongedaan worden gemaakt.",
      "logs.delete_failed": "Verwijderen van log is mislukt.",
      "logs.delete_all_partial":
        "{deleted} van {total} logs verwijderd. {failed} mislukt.",
      "logs.loading_preview": "Run-preview laden...",
      "logs.preview_unavailable": "Preview is niet beschikbaar voor deze run.",
      "logs.preview_heatmap_title": "Preview-heatmap (p95 intensiteit)",
      "logs.preview_stats_title": "Sensorstatistieken",
      "logs.load_insights": "Inzichten laden",
      "logs.reload_insights": "Inzichten herladen",
      "logs.loading_insights": "Inzichten laden...",
      "logs.summary_created": "Aangemaakt",
      "logs.summary_updated": "Bijgewerkt",
      "logs.summary_size": "Bestandsgrootte",
      "logs.summary_sensor_count": "Sensoren",
      "logs.not_available": "n.v.t.",
      "logs.table.location": "Locatie",
      "logs.table.samples": "Samples",
      "logs.table.dropped_delta": "Verlies Δ",
      "logs.table.overflow_delta": "Overflow Δ",
