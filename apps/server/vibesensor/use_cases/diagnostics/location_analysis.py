...
from vibesensor.infra.config.constants import MULTI_SENSOR_CORROBORATION_DB
from vibesensor.shared.utils.json_utils import as_float_or_none as _as_float
from vibesensor.shared.utils.locations import has_any_wheel_location, is_wheel_location
