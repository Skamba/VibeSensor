...
from vibesensor.shared.types.json import JsonObject, JsonValue
from vibesensor.shared.types.json import (
...
if TYPE_CHECKING:
    from vibesensor.adapters.persistence.boundaries.vibration_origin import SuspectedVibrationOrigin
