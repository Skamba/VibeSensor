...
from vibesensor.domain.diagnostics.finding import speed_band_sort_key, speed_bin_label
...
from vibesensor.shared.utils.locations import label_for_code as _label_for_code
