...
Framework-agnostic: raises domain exceptions from ``vibesensor.shared.errors``
...
from vibesensor.shared.errors import AnalysisNotReadyError, ProcessingError
from vibesensor.shared.types.backend import CarConfigPayload, HistoryRunPayload
