    ...
    return ReportDocumentSections(
        ...
        traceability_rows=tuple(
            build_traceability_rows(
                ...
                strength_algorithm_version=context.run_facts.strength_algorithm_version,
                peak_detector_version=context.run_facts.peak_detector_version,
                calibration_profile_id=context.run_facts.calibration_profile_id,
                vehicle_baseline_profile_id=context.run_facts.vehicle_baseline_profile_id,
