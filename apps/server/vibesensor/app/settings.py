...
and `vibesensor.shared.process_settings` owns the typed env/process overrides.
This facade preserves the stable `vibesensor.app.settings` import path for app
and CLI callers.
"""
