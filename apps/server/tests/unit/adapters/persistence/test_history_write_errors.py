...
from vibesensor.infra.metrics import RunRecorder, RunRecorderConfig
from vibesensor.infra.metrics.logger import _MAX_HISTORY_CREATE_RETRIES
...
class TestDroppedSamplesLogged:
    ...
    def test_dropped_samples_logged_when_create_run_failed(self, tmp_path: Path) -> None:
        ...
        with patch("vibesensor.infra.metrics.logger.LOGGER") as mock_logger:
            logger._append_records(run_id, start_utc, start_mono)
