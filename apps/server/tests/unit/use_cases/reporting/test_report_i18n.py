...
from vibesensor.use_cases.reporting.pattern_parts import _DEFAULT_PARTS, why_parts_listed
...
def test_dutch_translation_audit_round_5_ui_and_python() -> None:
    ...
    # More accurate: "Verlies Delta" -> "Verloren Delta"
    assert ui["history.table.dropped_delta"] == "Verloren \u0394"

    # Dutch for overflow: "Overflow Delta" -> "Overloop Delta"
