...
class TestReport:
    ...
    def test_from_summary(self) -> None:
        from vibesensor.use_cases.reporting.mapping import build_report_from_summary
...
class TestBridgeMethods:
    ...
    def test_car_config_to_car(self) -> None:
        from vibesensor.shared.types.backend import CarConfig
    ...
    def test_sensor_config_to_sensor(self) -> None:
        from vibesensor.shared.types.backend import SensorConfig
    ...
    def test_speed_source_config_to_speed_source(self) -> None:
        from vibesensor.shared.types.backend import SpeedSourceConfig
