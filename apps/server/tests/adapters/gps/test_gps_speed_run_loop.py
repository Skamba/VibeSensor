...
async def test_run_reconnects_on_connection_failure(
    ...
    monkeypatch.setattr("vibesensor.adapters.gps.gps_speed._GPS_RECONNECT_DELAY_S", 0.02)
    monkeypatch.setattr("vibesensor.adapters.gps.gps_speed._GPS_RECONNECT_MAX_DELAY_S", 0.04)
...
async def test_run_resets_speed_on_disconnect(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("vibesensor.adapters.gps.gps_speed._GPS_RECONNECT_DELAY_S", 0.05)
...
async def test_run_disabled_polls_without_connecting(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("vibesensor.adapters.gps.gps_speed._GPS_DISABLED_POLL_S", 0.02)
