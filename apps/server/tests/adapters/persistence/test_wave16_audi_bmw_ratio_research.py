...
def test_wave16_ratio_source_rows_capture_g30_g60_a7_a8_context() -> None:
    ...
    assert "official_530i_xdrive_exact_context" in sources["BMW|5 Series (G30, 2017-2023)"]["sources"]
    assert "official_540i_exact_context" in sources["BMW|5 Series (G30, 2017-2023)"]["sources"]
    assert "official_i5_edrive40_tire_context" in sources["BMW|5 Series (G60, 2024-2026)"]["sources"]
    assert "official_us_service_mapping_contradiction" in sources["Audi|A7 Sportback (C7, 2011-2018)"]["sources"]
