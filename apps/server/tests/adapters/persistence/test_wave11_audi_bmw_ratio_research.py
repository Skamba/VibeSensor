...
def test_wave11_ratio_source_rows_capture_g42_g02_a5_q3_q5_context() -> None:
    ...
    assert "official_230i_market_scope_contradiction" in sources["BMW|2 Series Coupe (G42, 2022-2026)"]["sources"]  # noqa: E501
    ...
    _assert_contains_unresolved(sources["BMW|2 Series Coupe (G42, 2022-2026)"], [
        ...
        {
            "item": "EU applicability of the existing '6-speed manual' gearbox entry across 2022-2026 range",  # noqa: E501
            "reason": "Checked official BMW Germany/EU launch and current-market material now resolves the visible 220i and 230i petrol lineup as automatic-only, but this pass still did not recover one official market-by-market transmission matrix proving when, where, or whether the retained broad-row 6-speed manual entry applies.",  # noqa: E501
        },
    ])
    _assert_contains_unresolved(sources["BMW|X4 (G02, 2019-2025)"], [
        {
            "item": "BMW X4 xDrive20i exact gear-ratio and reverse-ratio applicability across the full G02 row span",  # noqa: E501
        ...
        {
            "item": "BMW X4 xDrive20i current optional wheel/tire matrix applicability and transmission subtype code",  # noqa: E501
            "reason": "Official BMW sources now prove the current Germany-market xDrive20i tire matrix and 8-Gang Steptronic wording, but they do not publish a gearbox subtype code or one exact official matrix proving unchanged 19/20/21-inch applicability across the full represented row.",  # noqa: E501
        },
    ])
    _assert_contains_unresolved(sources["Audi|A5 (B9, 2017-2024)"], [
        {
            "item": "Broad-row Audi A5 B9 40 TFSI production-data applicability across the full represented span",  # noqa: E501
    ...
    _assert_contains_unresolved(sources["Audi|Q3 (F3, 2019-2026)"], [
        {
            "item": "Audi Q3 40 TDI quattro production-data applicability across the represented old-generation row span",  # noqa: E501
    ...
    _assert_contains_unresolved(sources["Audi|Q5 (FY, 2017-2026)"], [
        {
            "item": "Broad-row Audi Q5 FY 40 TDI quattro production-data applicability across the represented span",  # noqa: E501
            "reason": "Checked official Germany-market FY evidence now proves at least two contradictory 40 TDI quattro states within the represented row: a 2019 6-speed manual package with final drive 2.647 and a 2024 7-speed S tronic package with final drive 5.302, so no single production mapping is safe without a year split.",  # noqa: E501
        },
        {
            "item": "Audi Q5 FY 40 TDI quattro exact optional tire matrix, gearbox-family code, and FY boundary",  # noqa: E501
            "reason": "Official Audi exact material now proves both the 2019 manual and 2024 S tronic 40 TDI quattro ratio packages and the shared 235/65 R17 basic tire, but it does not publish a gearbox-family code, a full optional wheel/tire matrix, or any FY continuity beyond Audi's own 'bis 2024' boundary.",  # noqa: E501
        },
    ])
