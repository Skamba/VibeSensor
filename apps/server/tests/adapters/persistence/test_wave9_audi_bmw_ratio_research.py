...
def test_wave9_ratio_source_rows_capture_g22_g01_g02_q3_context() -> None:
    ...
    assert sources["BMW|X3 (G01, 2018-2024)"]["unresolved"] == [
        ...
        {
            "item": "BMW X3 (G01, 2018-2024) full EU variant matrix beyond the exact xDrive30i mapping",
            "reason": "This pass resolves the exact xDrive30i final drive, top gear, and Germany-market tire fitments, but it does not establish the full official ratio and tire matrix for the other G01 variants represented by the broad row.",
        },
        {
            "item": "BMW X3 xDrive30i transmission subtype code",
            "reason": "Official BMW sources prove 8-Gang Steptronic wording but do not publish a gearbox subtype code such as a ZF 8HP variant number.",
        },
    ]
