...
def test_wave9_ratio_source_rows_capture_g22_g01_g02_q3_context() -> None:
    ...
    _assert_contains_unresolved(sources[g22_key], [
        {
        ...
        {
            "item": (
                "BMW M440i xDrive production-data applicability across the full "
                "G22 row span"
            ),
            "reason": (
    ...
    _assert_contains_unresolved(sources[g01_key], [
        {
            "item": (
        ...
        {
            "item": (
                "BMW X3 M40i production-data applicability across the full "
                "2018-2024 row span"
            ),
            "reason": (
        ...
        {
            "item": (
                "BMW X3 xDrive30i and M40i transmission subtype code"
            ),
            "reason": (
    ...
    _assert_contains_unresolved(sources[g02_key], [
        {
            "item": (
        ...
        {
            "item": (
                "BMW X4 M40i production-data applicability across the full G02 "
                "row span"
            ),
            "reason": (
        ...
        {
            "item": (
                "BMW X4 M40i exact optional wheel/tire matrix and transmission "
                "subtype code"
            ),
            "reason": (
    ...
    _assert_contains_unresolved(sources[q3_key], [
        {
            "item": (
        ...
        {
            "item": (
                "Schema-safe encoding of exact Audi Q3 40 TFSI quattro split "
                "final-drive values"
            ),
            "reason": (
