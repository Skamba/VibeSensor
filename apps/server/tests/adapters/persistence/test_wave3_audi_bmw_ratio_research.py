    ...
    assert sources["BMW|iX (I20, 2022-2026)"]["unresolved"] == [
        {
            ...
            "reason": "Exact official M60 sources checked in this pass confirmed drivetrain context and tire sizes, but they did not yield machine-readable exact front/rear or overall reduction ratios for the M60.",  # noqa: E501
        },
        {
            "item": "BMW iX M60 numeric top-gear ratio and broad-row applicability across 2022-2026",  # noqa: E501
            "reason": "Exact official M60 sources use single-speed wording rather than a numeric top-gear ratio, and this pass did not prove one exact EV ratio package across the broad 2022-2026 row.",  # noqa: E501
        },
    ]
    assert sources["Audi|RS 6 Avant (C8, 2020-2026)"]["unresolved"] == [
        {
            "item": "Audi RS 6 Avant exact production-data applicability across the full 2020-2026 row span",  # noqa: E501
            "reason": "This pass found exact Germany-market proof for 2023-2025 documents, but it did not retrieve matching official launch-year and full-span documents that prove one unchanged ratio and tire package across the entire row.",  # noqa: E501
        },
        {
            "item": "Audi RS 6 Avant public gearbox-family naming beyond '8-speed tiptronic'",
            "reason": "Official Audi exact sources confirm the transmission as 8-speed tiptronic but do not explicitly name the gearbox family as ZF 8HP.",  # noqa: E501
        },
    ]
    assert sources["Audi|RS 7 Sportback (C8, 2020-2026)"]["unresolved"] == [
        {
            ...
            "reason": "Checked official Audi family and supplier sources point to 285/30 R22, but this pass did not retrieve a base-RS7 Germany-market technical-data sheet that explicitly lists the optional 22-inch size.",  # noqa: E501
        },
        {
            "item": "Audi RS 7 Sportback production-data applicability across the full 2020-2026 row span",  # noqa: E501
            "reason": "This pass found matching launch-era 2020 and later 2024 Germany-market ratio documents, but the current Audi MediaCenter model hub labels the model family through 2025, so the repo's full 2020-2026 span still is not fully closed.",  # noqa: E501
        },
    ]
...
def test_wave3_variant_source_docs_track_exact_bmw_overrides() -> None:
    ...
    assert (
        "| M60i xDrive | S68 4.4L V8 Turbo | AWD | 8-speed Steptronic FD 3.385 TG 0.640 | BMW PressClub technical data | High |"  # noqa: E501
        in content
    )
    assert (
        "| M4 Competition xDrive | S58 3.0L I6 Turbo | AWD | 8-speed M Steptronic FD 3.154 TG 0.640 | BMW PressClub technical data | High |"  # noqa: E501
        in content
    )
