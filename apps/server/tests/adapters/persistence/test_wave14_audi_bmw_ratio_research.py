        ...
        [
            {
                ...
                "reason": "The recovered official BMW Germany launch price list proves a 225/55 R17 baseline with 18/19/20-inch options for the 530i, contradicting the current broad-row tire defaults, but this pass did not recover later official archived price lists proving one year-spanning 2017-2023 530i wheel matrix safe enough for a production rewrite.",  # noqa: E501
            }
        ],
    )
    _assert_contains_unresolved(
        ...
        [
            {
                ...
                "reason": "Checked official Germany search and facelift material resolve the petrol D5 A8 to 55 TFSI quattro, while Audi explicitly describes the lower-output 210 kW 3.0 TFSI variant as China-only, so this pass did not recover an official Germany 50 TFSI quattro technical-data sheet or price-list row.",  # noqa: E501
            }
        ],
    )
    _assert_contains_unresolved(
        ...
        [
            {
                ...
                "reason": "Checked official Germany launch/current Q7 model pages, press releases, and 2020/2026 price-list material resolve the petrol SUV to 55 TFSI quattro / 250 kW instead, and this pass did not recover an official Germany 45 TFSI quattro technical-data sheet that would justify reusing the 55 TFSI data.",  # noqa: E501
            }
        ],
    )
