...
_REPORT_MAPPING_MODULE = _SERVER_PKG / "adapters" / "pdf" / "mapping.py"
...
def test_external_module_uses_analysis_public_api(module_path: Path) -> None:
    """Files outside diagnostics must use the public diagnostics package."""
    ...
    assert not violations, (
        ...
        "(must use the public package import "
...
def _live_processing_files() -> list[str]:
    ...
    files.append("adapters/udp/udp_data_rx.py")
    return files
