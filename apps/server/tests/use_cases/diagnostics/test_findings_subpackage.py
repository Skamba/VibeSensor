"""Boundary round-trip tests plus justified pure ranking seams for findings."""
...
# public analysis pipeline only exposes their combined downstream score/order.
...
class TestDetectDiffuseExcitation:
    """Stable pure seam: excitation diffusion scoring stays unit-testable."""
...
class TestComputeOrderConfidence:
    """Stable pure seam: confidence scoring stays unit-testable."""
...
class TestSuppressEngineAliases:
    """Stable pure seam: alias suppression stays unit-testable."""
