...
export function createCarWizardFeature(ctx) {
  ...
  function buildWizardCarName(brand, model) {
  ...
  function updateWizTireInputs(tire) {
    const tw = document.getElementById("wizTireWidth");
    const ta = document.getElementById("wizTireAspect");
    const ri = document.getElementById("wizRim");
  ...
  function bindWizardHandlers() {
    ...
    document.getElementById("wizardCustomBrandBtn")?.addEventListener("click", () => {
      const input = document.getElementById("wizardCustomBrand");
    ...
    document.getElementById("wizardCustomTypeBtn")?.addEventListener("click", () => {
      const input = document.getElementById("wizardCustomType");
      const val = input?.value?.trim();
      if (!val) return;
    ...
    document.getElementById("wizardCustomModelBtn")?.addEventListener("click", () => {
      const input = document.getElementById("wizardCustomModel");
      const val = input?.value?.trim();
      if (!val) return;
      wizState.model = val;
      wizState.selectedModel = null;
    ...
    document.getElementById("wizardManualAddBtn")?.addEventListener("click", async () => {
      const tw = Number(document.getElementById("wizTireWidth")?.value);
      const ta = Number(document.getElementById("wizTireAspect")?.value);
      const ri = Number(document.getElementById("wizRim")?.value);
      const fd = Number(document.getElementById("wizFinalDrive")?.value);
      const gr = Number(document.getElementById("wizGearRatio")?.value);
