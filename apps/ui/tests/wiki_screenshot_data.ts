...
export const wikiAnalysisSettings = {
  ...
  tire_width_mm: 225,
  wheel_bandwidth_pct: 5,
} satisfies AnalysisSettingsPayload;

export const wikiSpeedSourceSettings = {
  manual_speed_kph: 68,
  speed_source: "gps",
  stale_timeout_s: 5,
} satisfies SpeedSourcePayload;
...
export const wikiSpeedSourceStatus = {
  ...
  speed_source: "gps",
  stale_timeout_s: 5,
} satisfies SpeedSourceStatusPayload;
...
] satisfies ClientLocationsResponse["locations"];
