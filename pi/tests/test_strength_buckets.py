...
from vibesensor.strength_scoring import strength_db_above_floor
...
def test_persistence_and_decay_behavior() -> None:
    ...
    for _ in range(3):
        out = severity_from_peak(strength_db=17.0, band_rms=0.007, sensor_count=1, prior_state=state)
