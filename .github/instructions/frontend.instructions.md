...
- Keep polling, timers, WebSocket/session state, and other shared runtime state centralized. Reuse `apps/ui/src/app/features/polling_controller.ts`, `apps/ui/src/app/runtime/ui_live_transport_controller.ts`, and `apps/ui/src/app/ui_app_state.ts` instead of introducing duplicate per-feature loops or freshness owners.
